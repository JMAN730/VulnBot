...
from clawbot.config.settings import (
...
from clawbot.i18n import _
from clawbot.orchestrator import run_agent_task
from clawbot.repl_runner import run_repl_call
from clawbot.target_state.store import (
    ...
    while True:
        try:
            ...
            if cmd_lower in ("exit", "quit", "q"):
                ...
                from clawbot.agent.core import PersistentCycleResult
...
def _generate_report_for_target(
    ...
    *,
    ...
    from clawbot.report.generator import generate_report, generate_report_from_target_state
    from clawbot.target_state.store import load_target_state
...
def report(
    ...
    if target_mode:
        from clawbot.report.generator import generate_report_from_target_state
...
def config_provider(
    ...
    # Switch provider
    from clawbot.config.schema import PROVIDER_PRESETS, LLMProvider
...
def kb_update() -> None:
    ...
    from clawbot.kb.updater import seed_knowledge_base
...
def _auto_save_recon_report(agent, user_input: str, config) -> None:
    ...
    try:
        ...
        from clawbot.report.generator import generate_report
...
def tui(
    ...
    if once and target:
        from clawbot.cli.tui import render_tui_home
...
def web(
    ...
    from clawbot.web.app import FASTAPI_AVAILABLE
    ...
    from clawbot.web.app import create_app
