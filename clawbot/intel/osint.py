"""OSINT reconnaissance for ClawBot.

Ported from HackBot (``hackbot/core/osint.py``) and rewritten for ClawBot's
...
in worker threads. ``dnspython`` is an optional enhancement (``clawbot[osint]``);
