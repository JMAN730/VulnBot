...
def generate_report(
    ...
    from clawbot.report.filter import deduplicate_report_findings
    ...
    if output_path is None:
        from clawbot.config.settings import SESSIONS_DIR
    ...
    from clawbot.report.filter import ReportContentFilter
...
def _generate_attack_summary_from_session(session: SessionState) -> str:
    ...
    try:
        ...
        from clawbot.agent.think_filter import strip_think_tags
