...
from clawbot.agent.constraint_policy import validate_tool_action
...
async def execute_mcp_tool(agent: Any, tool_name: str, args: dict[str, Any]) -> str:
    ...
    if tool_name == "crypto_decode":
        try:
            from clawbot.skills.crypto_tools import execute as crypto_execute
...
def _write_python_audit(
    ...
    *,
    ...
    try:
        ...
        from clawbot.config.settings import PYTHON_EXECUTE_AUDIT_FILE, ensure_dirs
