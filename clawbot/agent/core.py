...
from clawbot.agent.anti_loop import (
    detect_attack_path,
...
from clawbot.agent.builtin_tools import (
    BLOCKED_PATTERNS,
    RESERVED_IP_RANGES,
    build_openai_tools,
    execute_mcp_tool,
...
from clawbot.agent.context import ContextManager, PentestPhase, SessionState, TaskConstraints
from clawbot.agent.ctf_mode import detect_flag_claim
from clawbot.agent.finding_parser import FindingParser
from clawbot.agent.input_analysis import (
    detect_phase,
    detect_target,
...
from clawbot.agent.kb_context import build_kb_context
from clawbot.agent.llm_client import StreamSink, call_llm
from clawbot.agent.loop_controller import auto_pentest as run_auto_pentest
from clawbot.agent.loop_controller import persistent_pentest as run_persistent_pentest
from clawbot.agent.prompt_context import build_round_context, generate_attack_summary
from clawbot.agent.recon_tracker import update_recon_dimension_completion
from clawbot.agent.runtime_state import AgentResult, PersistentCycleResult, RuntimeState
...
try:
    from clawbot.kb.retriever import KnowledgeRetriever, RetrieverStatus
except Exception:
...
class AgentCore:
    ...
    def _extract_response(message: Any) -> str:
        ...
        from clawbot.agent.llm_client import extract_response
