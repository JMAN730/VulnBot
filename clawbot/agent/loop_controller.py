...
from clawbot.agent.constraint_policy import validate_phase_transition
from clawbot.agent.context import PentestPhase
from clawbot.agent.ctf_mode import update_ctf_state
from clawbot.agent.llm_client import call_llm_auto
from clawbot.agent.runtime_state import AgentResult, PersistentCycleResult
...
async def persistent_pentest(
    ...
    *,
    ...
    while not should_stop:
        ...
        if auto_report:
            try:
                from clawbot.report.generator import generate_persistent_cycle_report
