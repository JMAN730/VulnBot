"""Textual-powered TUI workbench for VulnBot."""
...
import vulnbot.cli.tui as _tui
...
class DashboardScreen(Screen):
    ...
    def _run_subprocess(self, draft: Any, nl_text: str | None = None) -> None:
        ...
        from vulnbot.cli.tui import build_command_preview_args

        cmd_args = build_command_preview_args(draft, nl_text=nl_text)
        args = [sys.executable, "-m", "vulnbot.cli.main"] + cmd_args[1:]
