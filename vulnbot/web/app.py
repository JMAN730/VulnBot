"""FastAPI app entry for the VulnBot Web UI backend."""
...
from vulnbot.web.services.target_service import (
    clear_target,
    get_diff,
    get_preview,
    get_snapshots,
...
from vulnbot.web.services.task_service import start_task
...
def create_app(
    *,
    ...
    @app.get("/api/health")
    async def health():
        return {"status": "ok", "service": "vulnbot-web"}
