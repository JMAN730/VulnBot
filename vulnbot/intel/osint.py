"""OSINT reconnaissance for VulnBot.

Ported from HackBot (``hackbot/core/osint.py``) and rewritten for VulnBot's
...
in worker threads. ``dnspython`` is an optional enhancement (``vulnbot[osint]``);
